...
export const ko: TranslationMap = {
  ...
  employee: {
    heroTitle: "Soc PlatformClaw를 시작하세요.",
    heroCopy: "할당된 에이전트의 워크스페이스에 접근합니다.",
    ...
    signIn: "로그인",
    signInWithSso: "AD SSO로 로그인",
    dismissNotice: "공지 닫기",
    openNotice: "공지 열기",
  },
  employeeHeartbeat: {
    title: "에이전트 상태",
    subtitle: "현재 담당 에이전트의 최근 전달 상태와 기상 신호를 확인합니다.",
    recentStatus: "최근 상태",
    configStatus: "설정 상태",
    ...
    lastReceivedAt: "최근 수신 시각",
    lastDeliveryInfo: "최근 전달 정보",
    noTarget: "대상 없음",
    previewFallback: "최근 heartbeat 미리보기가 없습니다.",
    statusStable: "Heartbeat 안정",
    statusMonitor: "Heartbeat 모니터",
    statusSummaryFallback: "최근 전달 상태를 기준으로 자동 갱신됩니다.",
  },
  skills: {
    subtitle: "설치된 스킬과 현재 상태입니다.",
    readOnlySubtitle: "이 워크스페이스에서 사용할 수 있는 스킬입니다.",
    browseTitle: "ClawHub에서 스킬 보기",
    browseAction: "스킬 스토어 보기",
    filterPlaceholder: "설치된 스킬 필터링",
    shown: "개 표시",
    skillHubCalloutPrefix: "스킬 탐색, 발행, 패키지 업로드, 공유 설치는 이제 전용",
    skillHubCalloutSuffix: "탭에서 관리합니다.",
    statusTabs: {
      all: "전체",
      ready: "준비됨",
      needsSetup: "설정 필요",
    ...
    sources: {
      ...
      configuredGlobal: { label: "구성된 전역" },
      projectGlobal: { label: "프로젝트 전역" },
      personalGlobal: { label: "개인 전역" },
      managed: {
        label: "관리형",
        description: "OpenClaw 관리 스킬",
      },
      builtIn: {
        label: "내장",
        description: "OpenClaw에 포함됨",
      },
      unknown: {
        label: "알 수 없음",
    ...
    diagnostics: {
      ariaLabel: "스킬 진단",
      title: "스킬 진단",
      subtitlePrefix: "이 워크스페이스의 최종 병합 결과입니다. 구성된 전역은",
      workspacePrefix: "워크스페이스:",
      unavailable: "사용 불가",
      readyCount: "준비됨",
      blockedCount: "차단됨",
      unavailableCount: "사용 불가",
      needsAttention: "확인이 필요함",
      notEligible: "사용 불가",
    },
    empty: {
      disconnectedTitle: "Gateway에 연결되지 않았습니다.",
    ...
    badges: {
      hub: "허브",
      hubInstalled: "허브에서 설치됨",
      workspaceLocal: "내 워크스페이스",
    },
    detail: {
      source: "소스",
      baseDir: "기본 디렉토리",
      missingRequirements: "누락된 요구사항",
      reasonPrefix: "사유:",
      updateToVersion: "v{version}으로 업데이트",
      deleteFromWorkspace: "워크스페이스에서 삭제",
    },
  },
  skillsShared: {
    reasons: {
      disabled: "비활성화됨",
      blockedByAllowlist: "허용 목록에 의해 차단됨",
    },
    badges: {
      bundled: "내장",
      eligible: "사용 가능",
  ...
  skillHub: {
    title: "스킬 허브",
    heroTitle: "공유 스킬 카탈로그",
    subtitleShort: "발행, 설치, 업데이트, 공유 스킬 관리를 한 곳에서 처리합니다.",
    subtitle:
      "먼저 워크스페이스에서 발행한 뒤, 직원 워크스페이스 전반에서 공유 스킬을 설치, 업데이트, 관리하세요.",
    composer: {
      title: "Skill Hub 업로드",
    ...
    badges: {
      uploadedByYou: "내가 업로드함",
      hidden: "숨김",
      hiddenFiles: "숨김 파일 포함",
      executableFiles: "실행 파일 포함",
      installed: "설치됨",
      updateAvailable: "업데이트 가능",
    },
    publish: {
      title: "워크스페이스에서 발행",
      subtitle: "기존 워크스페이스 스킬을 골라 공유 허브에 발행합니다.",
      collapsedHint: "내 워크스페이스에 발행 가능한 로컬 스킬이 {count}개 있습니다.",
      empty: "지금 발행할 수 있는 로컬 워크스페이스 스킬이 없습니다.",
      action: "발행",
      publishing: "발행 중...",
    },
    upload: {
      title: ".skill 패키지 업로드",
      subtitle: "내 컴퓨터에서 패키지된 스킬을 업로드합니다.",
      subtitleSuffix: "파일은 zip 기반 아카이브입니다.",
      collapsedHint: "패키지 업로드 영역이 접혀 있습니다.",
      edmPolicyNote: "현재 EDM 정책으로 인해 브라우저 업로드는 임시 미지원입니다.",
      chooseFile: ".skill 파일 선택",
      uploading: "업로드 중...",
      layoutPrefix: "권장 패키지 구조: 최상위 폴더 하나와 ",
      layoutSuffix: " 파일이 필요합니다.",
    },
    meta: {
      by: "업로더",
      installs: "설치",
    ...
    editor: {
      publishTitle: "스킬 발행",
      uploadTitle: "스킬 패키지 업로드",
      editMetadataTitle: "스킬 정보 수정",
      help: "스킬을 이해하기 쉬운 예시 프롬프트를 최대 3개까지 추가하세요. 선택사항이며, 업로더는 나중에도 수정할 수 있습니다.",
      prefillLoading: "기존 발행 정보를 불러오는 중입니다.",
      chooseFile: ".skill 파일 선택",
      noFile: "선택된 파일 없음",
      descriptionLabel: "설명",
      descriptionPlaceholder: "이 스킬이 무엇을 하는지 간결하게 설명하세요.",
      promptLabel: "프롬프트",
      promptPlaceholder: "이 스킬을 실제로 어떻게 요청하면 좋을지 예시를 입력하세요.",
      publishAction: "발행",
      uploadAction: "업로드",
    },
    messages: {
      commandCopied: "Knox 명령을 복사했습니다.",
      promptCopied: "예시 프롬프트를 복사했습니다.",
    },
    transfer: {
      title: "소유권 이전",
      searchPlaceholder: "이름, employeeId, 이메일로 검색",
      reasonPlaceholder: "사유 입력 (관리자 이전 시 필수)",
    },
    empty: {
      title: "이 화면과 일치하는 스킬이 없습니다.",
      body: "다른 탭을 보거나 검색을 지우거나, 먼저 워크스페이스 스킬을 발행해보세요.",
      notFound: "스킬을 찾을 수 없습니다.",
    },
    searchPlaceholder: "스킬 이름, 요약, slug로 검색",
    shown: "개 표시",
  },
  groups: {
    title: "Groups",
    subtitle: "Group과 Part 소속을 살펴보고, 권한이 있는 범위에서 멤버를 관리하세요.",
    showArchived: "보관된 항목 보기",
    selectedBadge: "선택됨",
    selectedGroup: "선택된 Group",
    empty: "아직 생성된 Group이 없습니다.",
    loadingDetail: "Group 상세 정보를 불러오는 중입니다.",
    selectHint: "Group을 선택하면 Part와 멤버를 볼 수 있습니다.",
    noDescription: "설명이 없습니다.",
    membersSection: "멤버",
    partsTitle: "{groupName} 안의 Parts",
    partsEmpty: "이 Group 아래에는 아직 생성된 Part가 없습니다.",
    scope: {
      group: "Group",
      part: "Part",
    },
    ...
    create: {
      title: "Create Group",
      subtitle: "이후에 Part를 추가할 수 있는 최상위 Group을 생성합니다.",
    },
    partCreate: {
      title: "Create Part",
      subtitle: "선택한 Group 아래에 Part를 추가합니다.",
    },
    members: {
      empty: "아직 배정된 멤버가 없습니다.",
      addTitle: "멤버 추가",
      searchPlaceholder: "이름, employeeId, 이메일로 검색",
      roleLabel: "Group 역할",
      memberHint: "이 범위에 소속되며, 리더나 관리자가 멤버십을 관리할 수 있습니다.",
      leaderHint: "이 범위의 멤버를 관리할 수 있습니다. Group 리더는 하위 Part까지 관리합니다.",
    },
  },
  admin: {
    title: "Admin",
    subtitle: "직원 계정, 역할, Group / Part 배정을 관리합니다.",
    searchLabel: "계정 검색",
    searchPlaceholder: "이름, employeeId, 이메일로 검색",
    empty: "필터와 일치하는 계정이 없습니다.",
    loadingDetail: "계정 상세를 불러오는 중입니다.",
    lastLogin: "최근 로그인",
    actions: {
      view: "보기",
      changeRole: "역할 변경",
      manageGroups: "Groups 관리",
      addTo: "추가:",
      remove: "제거",
    ...
    memberships: {
      title: "Memberships",
      empty: "배정된 Group 또는 Part가 없습니다.",
    },
    roleChange: {
      title: "역할 변경",
      fieldLabel: "전역 역할",
      memberHint: "일반 업무, Skill Hub 사용, 개인 워크스페이스 작업에 필요한 기본 권한입니다.",
      adminHint: "계정, Group, Part, 소유권 변경까지 관리할 수 있는 관리자 권한입니다.",
      confirmHint: "신중히 확인하세요. 전역 역할 변경은 관리자 권한에 즉시 반영됩니다.",
    },
  },
  chat: {
